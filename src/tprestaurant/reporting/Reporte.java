...
public class Reporte {
    ...
    public List<Cambio> menuModificacion(Menu menu1, Menu menu2) throws ExcepcionLogica {
    ...
    public List<Producto> rankingPrecios(List<String> grupos, Restaurant rest) throws ExcepcionLogica{
